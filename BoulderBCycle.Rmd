...
ggplot(dataset, aes(Return.Time)) + 
  ...
  guides(fill = FALSE)
```
1. Among 24 hour pass holders Tue-Thu checkout/return pattern is different from Fri-Mon. Tue-Thu checkout/returns doesn't dip as much in the middle of the day compared to Fri-Mon.

2. 7-day pass holders checkout/returns peak at around 15:00 from Mon-Thu, with Fri-Sun seeing peaks and drops throughout the day. The same pattern applies for semester pass holders. 
...
4. Maintenance peaks at 15:00 on weekdays and mornings and evenings on Saturdays and Sunday. There is a big drop in maintenance in the middle of the day of the weekend days. 