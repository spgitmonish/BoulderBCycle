...
# kNN
set.seed(7)
fit.knn <- train(Entry.Pass.Type~., data = trainingset, method = "knn", 
                 preProcess = c("center", "scale"), metric = metric, trControl = trainControl)

# Summarize accuracy of models
results <- resamples(list(lda = fit.lda, cart = fit.cart, nb = fit.nb, knn = fit.knn))
summary(results)
