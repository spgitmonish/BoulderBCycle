...
---
# __Introduction__
This project analyses Boulder B-cycle data to understand rider patterns from 2013 to Early 2016. The analysis is divided into sections where under each section a different aspect of the data set is explored. The following questions give an overview of the data set.

### What is the structure of your dataset?
There are 248544 observations of 13 variables. The variables include Checkout/Return Stations, Checkout/Return Time, Type of Pass, Day of the Week, Trip Duration, Bike Number and Rider/Operator number. Also included is a location dataset with latitude and longitude information along with other information about the Checkout/Return station

### How is the analysis divided?
The analysis is divided into Summary of Data, Exploring Data through visualizations(univariate and multivariate analysis) and usage of ML to try and predict pass type
...
The above section also corrects error in values, "RTD" and "14th & Canyon" probably mean the same station and that is handled in the summary section.
...
ggplot(riders, aes(Rider.or.Operator.Number)) + 
  ...
  xlab("Rider or Operator Number") +
  ylab("Count") +
  ggtitle("Rider/Operator Count seperated by Pass Type")
```

1. Looking at riders with more than 200 rides, some riders really like to use the B-cycle for
their rides. Faceting it by the pass type, we get a better understanding of what type of passes
they like to use. Annual is the biggest winner among people who use the bikes often(not
surprising) but there was a rider who did a little more than 200 rides using the 24 hour
pass(surprised that the person didn't think of other cheaper options). 

2. The number of rides by riders using Maintenance pass is very interesting, there are a lot of rides by a few users. This indicates that these are operators who regularly use and fix the
bikes.
...
ggplot(dataset, aes(Entry.Pass.Type)) + 
  ...
  xlab("Pass Type") +
  ylab("Count") +
  ggtitle("Pass Type Count")
```

From the plots above, it is clear that the Anuual pass is definitely the most popular, followed by the 24-hour type of rental. The 150-day and 7-day pass pale in comparison. Maintainance is another one which has relatively high use compared to 7-day and Semester(150-day) type. This might be a good visualization for the company to use to probably change the strategy with respect to these kind of passes. 
...
ggplot(bikes, aes(Bike.Number)) + geom_bar(aes(fill = Entry.Pass.Type)) + 
  ...
  xlab("Bike#") +
  ylab("Count") +
  ggtitle("Bike# Count seperated by Pass Type")
...
ggplot(bikes, aes(Bike.Number)) + geom_bar(aes(fill = Checkout.Day.of.Week)) + 
  ...
  xlab("Bike#") +
  ylab("Count") +
  ggtitle("Bike# Count seperated by Day of the Week")
...
ggplot(bikes, aes(Bike.Number)) + geom_bar(aes(fill = Checkout.Day.of.Week)) + 
  ...
  xlab("Bike#") +
  ylab("Count") +
  ggtitle("Bike# Count seperated by Pass Type & Day of the Week")
```

Was not expecting any trends in the plot above but surprisingly there is are some trends. Except for 7-day and Semester pass types, the bike numbers in the middle seem to be most used. This might be related to the stations they are at, as there are stations which are more popular than other ones as we will see below. 
...
ggplot(dataset, aes(Checkout.Day.of.Week)) + geom_bar(aes(fill = Entry.Pass.Type)) +
  ...
  xlab("Day of the Week") +
  ylab("Count") +
  ggtitle("Day of the Week Count seperated by Pass Type")
```
...
2. When looking at the data faceted by the pass type, Annual pass holders like to use their passes on weekdays(the distribution is almost gaussian like). It is completely opposite for the users of 24-hour pass type, they like riding on weekends. 

3. Maintenance rides seems to happen mostly on weekends. Semester pass holders like to use the pass on the weekdays with Tuesday seeing the most rides. In the case of the 7-day pass there is no visible trend but Thursday is when the most rides happen with 7-day pass holders, followed by Friday and Sunday. 
...
ggplot(duration, aes(Trip.Duration..Minutes.)) + 
  ...
  xlab("Trip Duration") +
  ylab("Count") +
  ggtitle("Trip Duration distribution seperated by Pass Type")
...
ggplot(duration, aes(Trip.Duration..Minutes.)) + 
  ...
  xlab("Trip Duration") +
  ylab("Count") +
  ggtitle("Trip Duration distribution seperated by Day of the Week")
...
ggplot(duration, aes(Trip.Duration..Minutes.)) + 
  ...
  xlab("Trip Duration") +
  ylab("Count") +
  ggtitle("Trip Duration distribution seperated by Pass Type and Day of the Week")
```
...
ggplot(dataset, aes(Checkout.Station)) + 
  ...
  ylab("Count") +
  ggtitle("Checkout Station Count")
...
ggplot(dataset, aes(Checkout.Station)) + 
  ...
  xlab("Checkout Station") +
  ylab("Count") +
  ggtitle("Checkout Station Count seperated by Day of the Week")
...
ggplot(dataset, aes(Checkout.Station)) + 
  ...
  xlab("Checkout Station") +
  ylab("Count") +
  ggtitle("Checkout Station Count seperated by Pass Type")
...
ggplot(duration, aes(Trip.Duration..Minutes.)) + 
  ...
  xlab("Trip Duration") +
  ylab("Count") +
  ggtitle("Trip Duration distribution seperated by Checkout Station")
```
...
ggplot(dataset, aes(Return.Station)) + 
  ...
  xlab("Return Station") +
  ylab("Count") +
  ggtitle("Return Station Count seperated by Pass Type")
...
ggplot(dataset, aes(Return.Station)) + 
  ...
  xlab("Checkout Station") +
  ylab("Count") +
  ggtitle("Return Station Count seperated by Day of the Week")
...
ggplot(duration, aes(Trip.Duration..Minutes.)) + 
  ...
  xlab("Trip Duration") +
  ylab("Count") +
  ggtitle("Trip Duration distribution seperated by Return Station")
```
...
ggplot(dataset, aes(Checkout.Date)) + 
  ...
  xlab("Checkout Date") +
  ylab("Count") +
  ggtitle("Checkout Date distribution")
...
ggplot(dataset, aes(Checkout.Date)) + 
  ...
  xlab("Checkout Date") +
  ylab("Count") +
  ggtitle("Checkout Date distribution seperated by Pass Type")
```
...
ggplot(dataset, aes(Checkout.Date)) + 
  ...
  xlab("Checkout Date") +
  ylab("Count") +
  ggtitle("Checkout Date distribution seperated by Day of the Week")
...
ggplot(dataset, aes(Checkout.Date)) + 
  ...
  xlab("Checkout Date") +
  ylab("Count") +
  ggtitle("Checkout Date distribution seperated by Pass Type and Day of the Week")
```
...
ggplot(dataset, aes(Checkout.Time)) + 
  ...
  xlab("Checkout Time") +
  ylab("Count") +
  ggtitle("Checkout Time distribution")
...
ggplot(dataset, aes(Return.Time)) + 
  ...
  xlab("Return Time") +
  ylab("Count") +
  ggtitle("Return Time distribution")
...
ggplot(dataset, aes(Checkout.Time)) + 
  ...
  xlab("Checkout Time") +
  ylab("Count") +
  ggtitle("Checkout Time distribution seperated by Pass Type")
...
ggplot(dataset, aes(Return.Time)) + 
  ...
  xlab("Return Time") +
  ylab("Count") +
  ggtitle("Return Time distribution seperated by Pass Type")
```
...
ggplot(dataset, aes(Checkout.Time)) + 
  ...
  xlab("Checkout Time") +
  ylab("Count") +
  ggtitle("Checkout Time distribution seperated by Day of the Week")
...
ggplot(dataset, aes(Return.Time)) + 
  ...
  xlab("Return Time") +
  ylab("Count") +
  ggtitle("Return Time distribution seperated by Day of the Week")
...
ggplot(dataset, aes(Checkout.Time)) + 
  ...
  xlab("Checkout Time") +
  ylab("Count") +
  ggtitle("Checkout Time distribution seperated by Pass Type & Day of the Week")
...
ggplot(dataset, aes(Return.Time)) + 
  ...
  xlab("Return Time") +
  ylab("Count") +
  ggtitle("Return Time distribution seperated by Pass Type & Day of the Week")
```
...
ggmap(map) +
  ...
  guides(fill = FALSE) + 
  ggtitle("Heat Map of Checkout Stations")
...
ggmap(map) +
  ...
  scale_size(range = c(0, 15)) + 
  guides(fill = FALSE) +
  ggtitle("Heat Map of Return Stations")
```
...
# __Machine Learning to predict the pass type__
```{r, warning = FALSE, echo = FALSE, fig.width = 10, fig.height = 10}
if(FALSE)
{
  ...
  set.seed(7)
  fit.svm <- train(Entry.Pass.Type~., data = trainingset, method = "svmRadial", 
                  metric = metric, trControl = trainControl)
